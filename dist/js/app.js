(() => {
    ...
    class ScrollWatcher {
        ...
        scrollWatcherCallback(entry, observer) {
            ...
            let arrayElements = [];
            if (targetElement.classList.contains("clients__person") && targetElement.classList.contains("_watcher-view")) {
                arrayElements = document.querySelectorAll(".person");
                document.querySelector(".clients__person");
    ...
    function animationSvg() {
        document.querySelector(".page__decor-1");
    ...
    function toChangeSVGSize() {
        const windowInnerWidth = window.innerWidth;
        var mySVG = document.querySelector(".booking__waves");
        if (windowInnerWidth < 1200 && windowInnerWidth > 769) mySVG.setAttribute("viewBox", "0 24 100 28"); else if (windowInnerWidth > 1200) mySVG.setAttribute("viewBox", "0 24 150 28"); else mySVG.setAttribute("viewBox", "0 24 50 28");
    }
    window["FLS"] = true;
    isWebp();
    menuInit();
